...
public class JFrame4 extends javax.swing.JFrame {
    ...
    public JFrame4(LocalDateTime start,LocalDateTime end) {
        this.start=start;
        this.end=end;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        List<TopStation>temp=StaticContext.getBean(StatisticService.class).topStation(start, end);
        Object[][] objs = new Object[temp.size()][2];
        for (int i=0; i<temp.size(); i++ ){
            objs[i][0]=temp.get(i).getStationName();
            objs[i][1]=temp.get(i).getPopularStation();
        }
